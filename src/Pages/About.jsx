    ...
    <div className="about">
        ...
        <div className="contenedorimgtext"><img className="fotowendy" src={image} alt=""/>
            <div className="contenerdortext">
                <p>Soy Bióloga hace aproximadamente 3 años, con experiencia en el area de investigación en biotecnologia vegetal. Me encantan las plantas, en especial las orquídeas y  también las aves</p>
                <p>Desde hace un tiempo me he venido interesando el area del desarrollo web, por tal motivo decidí cambiar de carrera, o quizas fusionar mi carrera con el desarrollo web, ya que creo que esta area tiene mucho potencial para poder tener mayor alcance en la ciencia</p>
                <ul>
